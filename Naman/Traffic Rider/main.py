...
pygame.display.set_caption("Traffic Rider (Made By Naman Mittal)")
...
def intro_loop():
    ...
    while intro:
        ...
        largetext=pygame.font.SysFont('agencyfb',60)
        textsurf,textrect=text_objects("Traffic Rider (Made By Naman Mittal)",largetext)
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
               ...
               if event.key==pygame.K_UP:
                  if obstacle_speed<22:
                      obstacle_speed+=1.5
               if event.key==pygame.K_DOWN:
                  if obstacle_speed>level*2:
                       obstacle_speed-=1
